  ...
  return (
    <WaveBackgroundLayout intensity="medium">
      ...
      <main className="flex flex-col items-center justify-center py-16">
        <h1 className="font-montserrat text-4xl font-bold">Light Theme Preview</h1>
        <p className="font-lora mt-2">This route showcases the shell with light theme tokens.</p>
